...
function fillInputProcedure(e) { // Preenche automáticamente o campo "procedimentos" de acordo com o código digitado
    ...
    if (input.value.length == 8) {
        ...
        let findValue = tuss.find(element => {
            return element.codigo == Number(input.value)
        })
        if (findValue) {
...
// Dados TUSS para consulta do preenchimento automático dos "inputs"
